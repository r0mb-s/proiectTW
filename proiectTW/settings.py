...
SECRET_KEY = 'django-insecure-6u1c^(kt1m0%j9a%pfx+jz0l9q*@%gn7xathwk$xo@&i)+o-uw'
...
DEBUG = True
ALLOWED_HOSTS = ['tw.freyda.work', '127.0.0.1']
...
LOGIN_REDIRECT_URL = 'dashboard/'  # Redirect to the home page (adjust as needed)
